...
public interface CarRepository extends JpaRepository< Car, Long> {
    ...
    List< Car> findAllByPrizeAndModelAndBrandAndKmAndTransmissionAndYearAndPetrolAndEngine(BigDecimal prize, String model, String brand, Integer km, Transmission transmission, Integer year,Petrol petrol,Double engine,Pageable pageable);
