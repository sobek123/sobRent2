...
public class RentCarApplication {
	...
	public CommandLineRunner loadData(CarService carService, AdditionalService additionalService, UserService userService, OrderService orderService, FullOrderService fullOrderService, ContactService contactService) {
      ...
      CarDTO carDTO106 =carService.addCar(new CarDTO(36L, "RX450h", "WA 92341", 200, 305, 6.1, new Price(BigDecimal.valueOf(1099), BigDecimal.valueOf(1299), BigDecimal.valueOf(1499), BigDecimal.valueOf(1699), BigDecimal.valueOf(1899), BigDecimal.valueOf(2099), BigDecimal.valueOf(18000)),
